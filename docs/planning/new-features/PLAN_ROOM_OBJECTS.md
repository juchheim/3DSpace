...
- **Limit:** ≤ 15 MB compressed; ≤ 200k triangles after Draco / meshopt decode; ≤ 8 textures; max texture 2048 × 2048.
...
- **Limits:** Same caps as upload (≤ 15 MB, ≤ 200k triangles). Composite exports (e.g. merged base-10 stack) may need a pre-export triangle count warning in the UI.
...
| Per-template triangle count | ≤ 200k triangles after decode |
