...
| [PLAN_AVATAR_GLB_RECOLOR.md](PLAN_AVATAR_GLB_RECOLOR.md) | UV mask + neutral albedo + luminance shader — wire 23 zone colors to Azure Vanguard GLB | **Shipped** (flag default off) |
| [IMPL_AVATAR_GLB_RECOLOR.md](IMPL_AVATAR_GLB_RECOLOR.md) | Phase 0–7 build plan: assets, registry, shader, BlockyAvatar, harness, QA, rollout | **Complete** |
