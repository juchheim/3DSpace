...
import { verseFromClassName } from "../lib/verses";
...
export function LegacyLobby() {
  ...
  const legacyRooms = rooms.filter(
    (room) => !verseFromClassName(classes.find((c) => c.id === room.classId)?.name)
  );
    ...
    <>
      ...
      <nav className="lb-nav">
        <div className="lb-nav-inner">
          ...
          <Link className="lb-btn lb-btn-sec lb-btn-sm" href="/">← Dream IXR</Link>
      ...
      <div className="lb-page">
        <div className="lb-inner">
          ...
          <header className="lb-header">
            <h1 className="lb-title">Legacy <em>rooms.</em></h1>
