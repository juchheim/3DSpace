...
export function BuildPreview2D({
  ...
  if (preview.mode === "destroy") {
    if (preview.piece.kind === "wall" || preview.piece.kind === "simple-wall" || preview.piece.kind === "doorway" || preview.piece.kind === "window") {
  ...
  if (preview.target.kind === "wall" || preview.target.kind === "simple-wall" || preview.target.kind === "doorway" || preview.target.kind === "window") {
