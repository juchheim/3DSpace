...
export const CEILING_FUTURISTIC_NATIVE_W = 1.9094572067260742;
export const CEILING_FUTURISTIC_NATIVE_H = 0.24969482421875;
...
export function futuristicCeilingWorldTransform(piece: BuildPiece) {
  ...
  const scaledH = CEILING_FUTURISTIC_NATIVE_H * scale;
...
export function FuturisticCeilingMesh({
  ...
  const { centerX, centerZ, y, scaledH, rotationY } = futuristicCeilingWorldTransform(piece);
