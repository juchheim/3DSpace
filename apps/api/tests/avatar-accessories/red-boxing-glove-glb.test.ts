...
const publicGlb = join(repoRoot, "apps/web/public/avatar-accessories/red-boxing-glove.glb");
const sourceGlb = join(repoRoot, "GLBs/red-boxing-glove.glb");
...
describe("red-boxing-glove public GLB asset", () => {
