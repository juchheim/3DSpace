...
| **Futuristic Dark Ceiling** | — | A flat dark sci-fi ceiling panel in one cell — visual only. Non-colliding; stacks with floors, lights, and other fixtures. Use **`R`** to rotate. |
