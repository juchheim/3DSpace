...
Last updated: 2026-06-01 (avatar physics setPosition guard)
...
- **FFA AI World Host:** `docs/planning/rooms/free-for-all/aibot/PLAN_FREE_FOR_ALL_AI_WORLD_HOST.md`, `IMPL_FREE_FOR_ALL_AI_WORLD_HOST.md` — named retro-robot NPC; build-help tutor + persistent file study chat. On `feature/aibot`: **Phases 1–2 (contracts+API), 4 (client hook/HUD), 5 (corpus + Build Help SSE chat) complete**; Phase 3 (avatar) separate; Phase 6 (files) + 7 (polish/E2E) pending
