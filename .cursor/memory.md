...
- **FFA AI World Host:** `docs/planning/rooms/free-for-all/aibot/PLAN_FREE_FOR_ALL_AI_WORLD_HOST.md`, `IMPL_FREE_FOR_ALL_AI_WORLD_HOST.md` — named retro-robot NPC; build-help tutor + persistent file study chat; planning only
...
- **2026-06-01:** **FFA AI World Host planned** — `docs/planning/rooms/free-for-all/aibot/`: PLAN + IMPL for named retro-robot host (`RetroRobotHostAvatar`), Build Help (world-building corpus + context), Study Files (R2 upload, extract, per-user RAG chat, persist until delete); flag `aiWorldHost`; 7 phases. Not implemented.
