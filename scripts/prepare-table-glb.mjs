// Prepare table-6-walnut.glb for World Builder:
//   - Base-color PNGs → JPEG q85 (normals stay PNG)
//
// Run:  node scripts/prepare-table-glb.mjs [in.glb] [out.glb]
// Default: GLBs/table-6-walnut.glb → apps/web/public/objects/table-6-walnut.glb
...
const DEFAULT_IN = resolve(__dirname, "../GLBs/table-6-walnut.glb");
const DEFAULT_OUT = resolve(__dirname, "../apps/web/public/objects/table-6-walnut.glb");
