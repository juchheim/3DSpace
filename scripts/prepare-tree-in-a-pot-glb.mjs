// Prepare tree-in-a-pot.glb for World Builder:
//   - Re-encode textures as JPEG q85 (PNG/WebP → JPEG when present)
//   - Prune unused nodes/data
//
// Run:  node scripts/prepare-tree-in-a-pot-glb.mjs [in.glb] [out.glb]
// Default: GLBs/tree-in-a-pot.glb → apps/web/public/objects/tree-in-a-pot.glb
...
const DEFAULT_IN = resolve(__dirname, "../GLBs/tree-in-a-pot.glb");
const DEFAULT_OUT = resolve(__dirname, "../apps/web/public/objects/tree-in-a-pot.glb");
