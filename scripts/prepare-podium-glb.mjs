// Prepare podium.glb for World Builder:
//   - Base-color PNGs → JPEG q85 (normals stay PNG)
//   - Oversized JPEG base colors re-encoded to q85
//
// Run:  node scripts/prepare-podium-glb.mjs [in.glb] [out.glb]
// Default: GLBs/podium.glb → apps/web/public/objects/podium.glb
...
const DEFAULT_IN = resolve(__dirname, "../GLBs/podium.glb");
const DEFAULT_OUT = resolve(__dirname, "../apps/web/public/objects/podium.glb");
