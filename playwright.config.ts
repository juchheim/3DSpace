...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_SKIP_WEB_SERVER
    ...
    : [
        {
          command:
            "ENABLE_CLASSROOM_LESSONS=true ENABLE_BREAKOUT_PODS=true ENABLE_ROOM_OBJECTS=true ENABLE_WORLD_SKINS=true ENABLE_WORKFORCE_TRAINING=true ENABLE_FREE_FOR_ALL=true FREE_FOR_ALL_PASSWORD=open-sesame ENABLE_FREE_FOR_ALL_BUILDING=true BUILD_PLACEMENT_RATE_LIMIT_PER_MINUTE=600 ENABLE_SHARED_BROWSERS=true HYPERBEAM_API_KEY=e2e_hyperbeam_key HYPERBEAM_API_BASE=http://127.0.0.1:19098 npm --workspace @3dspace/api run dev",
